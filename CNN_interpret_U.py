...
def choose_validation(size, classes):
    ...
    valid_dataset = ImageDataset(data_folder='data/EXP2/U/', classes=classes)
...
path_model = 'models/CNN_statedict_trainwithU.pt'
model = CNN()
...
np.savez('models/validation_result_U/CNN_interpret_masksize{}.npz'.format(zeros_len),\
